  ...
  return (
    <Steps>
      <GetStartedStep title="Welcome!">
        <p>In this guide you will learn how to add RDO Compendium to your server. To make sure you don't get overwhelmed by information right away, this guide is step based.</p>
        <p>These steps will take you through the process of adding RDO Compendium to your server. It will guide you through each of the steps of adding it and explain some things about the steps you'll take. At the end of the guide, you'll have RDO Compendium added to your bot, and you can start using it.</p>
        <p>If by the end of the steps you feel like you've missed something or if you just can't quite figure something out, we're here to help! Just <a href="https://rdo.gg/discord/" target="_blank" rel="noreferrer">join the support server</a> and ask us to help you with getting RDO Compendium set up.</p>
        <p>Why don't you click the Continue button to get started?</p>
      </GetStartedStep>
      <GetStartedStep title="First things first">
        <p>To get started, you'll need to add RDO Compendium to your server. To do this, head to the <a href="https://rdo.gg/invite/" target="_blank" rel="noreferrer">bot invite page</a>. Once you're on the page you should see something like this:</p>
        ...
        <p>Pfew, that's a bit of information. What it's actually telling you is that you're about to add RDO Compendium to one of your servers. It mentions that it will be able to create commands, and that's exactly what we want! What Discord means with being able to create commands is that RDO Compendium will be able to show commands like <code className="text-black dark:text-white">/find</code> to the users in your server.</p>
        <p>Let's go ahead and add RDO Compendium! Click Continue.</p>
      </GetStartedStep>
      <GetStartedStep title="Select your server">
        ...
        <p>If you click this box, you'll select the server you'll add RDO Compendium to. Maybe you have more than one server to add RDO Compendium to. If that's the case, pick one now! If you want to add RDO Compendium to multiple servers, you can always repeat these steps later.</p>
      ...
      <GetStartedStep title="What are permissions?">
        ...
        <p>To make RDO Compendium work like it's supposed to, there's several things RDO Compendium needs to be able to do. RDO Compendium asks for those things right here. While you can find a more detailed explanation on the next page, the gist of these permissions is that RDO Compendium needs to be able to respond to your commands. To accomplish responding, it'll need to be able to. That's what you're granting here; the ability for RDO Compendium to effectively respond.</p>
      ...
      <GetStartedStep title="All about permissions">
        ...
        <ul>
          ...
          <li>Send Messages: Used to send messages in channels RDO Compendium has access to. RDO Compendium uses this to occasionally send a message to respond to you, or to notify you of any changes in RDO Compendium.</li>
          ...
          <li>Attach Files: Used to be able to upload media in channels RDO Compendium has access to. RDO Compendium uses this to be able to post images of for the location of Bears.</li>
        ...
        <p>That was a lot of reading. I don't blame you if you skipped some or all of it. In general, all you need to know is that with these permissions RDO Compendium can't kick or ban users, delete your channels, or do anything scary.</p>
        <p>Click Continue when you're ready.</p>
      </GetStartedStep>
      <GetStartedStep title="Almost there...">
        <p>Are you ready to get started with RDO Compendium? All you need to do is click the "Authorize" button:</p>
        <div className="mb-4 text-center">
        ...
        <p>If you need to make changes to the permissions, feel free to do so now, though do note that if you disable too much, RDO Compendium may not be able to respond to you properly. If that's the case, you can always re-do these steps later by kicking RDO Compendium and following these steps again!</p>
        <p>Now, for the grand finale, click Continue.</p>
      </GetStartedStep>
      <GetStartedStep title="All done!">
        <p>That's it! You're done! RDO Compendium will now have joined your server, and you're ready to get started with RDO Compendium. Try out some commands and enjoy!</p>
        <div className="mb-4 text-center">
        ...
        <h3>Next steps</h3>
        <p>Now that you've added RDO Compendium, there's several things you can. Of course, you can start using commands right away, but if you need some pointers, try the following:</p>
        <ul>
          <li>Check out the <a href="/wiki/guides/commands">commands guide</a> for a list of commands and how to use them.</li>
          <li>Check out the <a href="/wiki/guides/settings">settings guide</a> for ways to configure RDO Compendium to your liking.</li>
          <li>Check out the <a href="/wiki/faq">FAQ page</a> for a list of frequently asked questions.</li>
          <li>Loving RDO Compendium? Check out the <a href="/wiki/guides/premium">Premium guide</a> to see what you get if you decide you want a little more.</li>
