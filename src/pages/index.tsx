                ...
                <Link to="https://rdo.gg/invite/" className="min-h-[30vh] lg:min-h-[40vh] flex flex-wrap w-full py-32 px-10 relative">
                  ...
                  <div className="absolute inset-0 p-8 lg:p-16 bg-[#9725] hover:bg-transparent flex justify-center items-center transition-colors">
                    <div className="w-full text-white">
                      ...
                      <hr className="my-4" />
                      <p className="leading-relaxed line-clamp-4 md:line-clamp-3 mb-0">RDO Compendium is a bot that allows you to locate different types of collectibles, missions, herbs, animals, shops, treasures, and more within Red Dead Redemption 2 and Red Dead Online.</p>
                    </div>
                  </div>
                </Link>
              </div>
                ...
                <Link to="https://rdo.gg/patreon/" className="min-h-[30vh] flex flex-wrap w-full sm:py-24 py-16 sm:px-10 px-6 relative">
                  ...
                  <div className="absolute inset-0 p-8 lg:p-16 bg-[#9725] hover:bg-transparent flex justify-center items-center transition-colors">
                    <div className="w-full text-white">
                      ...
                      <hr className="my-4" />
                      <p className="leading-relaxed line-clamp-4 md:line-clamp-3 mb-0">If you one day find yourself impressed by the bot, please consider pledging to our Patreon. It helps a lot, and you get some cool features in return.</p>
                    </div>
                  </div>
                </Link>
              </div>
                ...
                <Link to="https://rdo.gg/twitter/" className="min-h-[30vh] flex flex-wrap w-full sm:py-24 py-16 sm:px-10 px-6 relative">
                  ...
                  <div className="absolute inset-0 p-8 lg:p-16 bg-[#9725] hover:bg-transparent flex justify-center items-center transition-colors">
                    <div className="w-full text-white">
                      ...
                      <hr className="my-4" />
                      <p className="leading-relaxed line-clamp-4 md:line-clamp-3 mb-0">Read all about the latest news, tips, and updates on Twitter. Also, feel free to connect with us through DM!</p>
                    </div>
                  </div>
                </Link>
              </div>
                ...
                <Link to="https://rdo.gg/discord/" className="min-h-[30vh] flex flex-wrap w-full sm:py-24 py-16 sm:px-10 px-6 relative">
                  ...
                  <div className="absolute inset-0 p-8 lg:p-16 bg-[#9725] hover:bg-transparent flex justify-center items-center transition-colors">
                    <div className="w-full text-white">
                      ...
                      <hr className="my-4" />
                      <p className="leading-relaxed line-clamp-4 md:line-clamp-3 mb-0">Join the Discord Server now to get help if you experience issues, read about updates, ask questions, or just chat.</p>
                    </div>
                  </div>
                </Link>
              </div>
                ...
                <Link to="https://rdo.gg/api/" className="min-h-[30vh] flex flex-wrap w-full sm:py-24 py-16 sm:px-10 px-6 relative">
                  ...
                  <div className="absolute inset-0 p-8 lg:p-16 bg-[#9725] hover:bg-transparent flex justify-center items-center transition-colors">
                    <div className="w-full text-white">
                      ...
                      <hr className="my-4" />
                      <p className="leading-relaxed line-clamp-4 md:line-clamp-3 mb-0">The RDO.GG API is a developer resource that aims to centralize most data for use in various applications.</p>
                    </div>
                  </div>
                </Link>
              </div>
